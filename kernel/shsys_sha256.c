...
#define SWAP_BE32(x) (uint32_t)   ( \
                (((uint32_t)(x) & 0xff000000u) >> 24) | \
                (((uint32_t)(x) & 0x00ff0000u) >>  8) | \
                (((uint32_t)(x) & 0x0000ff00u) <<  8) | \
                (((uint32_t)(x) & 0x000000ffu) << 24))

#define bb_bswap_64(x) (uint64_t)   ( \
...
void *sha256_buffer(const char *buffer, unsigned long len, void *resblock)
{
    sha256_ctx_t ctx;
    int i, l;
    ...
    for (i = 0; i < len; i += 4096) {
        l = (len - i >= 4096) ? 4096 : len - i;
        sha256_hash(&ctx, &buffer[i], l);
    }
    sha256_end(&ctx, resblock);
