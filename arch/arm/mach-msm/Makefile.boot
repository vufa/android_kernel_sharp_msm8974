...
#        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974-v2.2-mtp.dtb
        dtb-$(CONFIG_MACH_JOLYNE)	+= msm8974-sharp-jolyne-v2.0-1.dtb
        dtb-$(CONFIG_MACH_JOLYNE)	+= msm8974-sharp-jolyne-v2.2.dtb
        dtb-$(CONFIG_MACH_LYNX_DL40)	+= msm8974-sharp-dl40-v2.0-1.dtb
        dtb-$(CONFIG_MACH_LYNX_DL40)	+= msm8974-sharp-dl40-v2.2.dtb
        dtb-$(CONFIG_MACH_DECKARD_AS97)	+= msm8974-sharp-as97-v2.0-1.dtb
        dtb-$(CONFIG_MACH_DECKARD_AS97)	+= msm8974-sharp-as97-v2.2.dtb
        dtb-$(CONFIG_MACH_ATK)	+= msm8974-sharp-pa21-v2.0-1.dtb
        dtb-$(CONFIG_MACH_ATK)	+= msm8974-sharp-pa21-v2.2.dtb
        dtb-$(CONFIG_MACH_DECKARD_AS87)	+= msm8974-sharp-as87-v2.0-1.dtb
        dtb-$(CONFIG_MACH_DECKARD_AS87)	+= msm8974-sharp-as87-v2.2.dtb
        dtb-$(CONFIG_MACH_DECKARD_GP7K)	+= msm8974-sharp-gp7k-v2.0-1.dtb
        dtb-$(CONFIG_MACH_DECKARD_GP7K)	+= msm8974-sharp-gp7k-v2.2.dtb
        dtb-$(CONFIG_MACH_LYNX_DL45)	+= msm8974-sharp-dl45-v2.0-1.dtb
        dtb-$(CONFIG_MACH_LYNX_DL45)	+= msm8974-sharp-dl45-v2.2.dtb
        dtb-$(CONFIG_MACH_TBS)	+= msm8974-sharp-pa23-v2.0-1.dtb
        dtb-$(CONFIG_MACH_TBS)	+= msm8974-sharp-pa23-v2.2.dtb
