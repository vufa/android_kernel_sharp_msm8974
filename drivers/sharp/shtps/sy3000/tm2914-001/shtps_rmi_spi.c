...
#define SHTPS_TOUCH_CANCEL_COORDINATES_Y		9999
	...
	#define	SHTPS_LOG_WAKEUP_FAIL_TOUCH_EVENT_REJECT(...)					\
		...
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X =	61;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y =	1214;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE = 		686;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO =		113;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2 =		76;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME =	578;
		...
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X	61
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y	1214
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE		686
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO		113
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2		76
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME	578
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#define SHTPS_REG_OFFSET_SEGMENTATION_AGGRESSIVENESS	0x1F
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int	SHTPS_SMOOTH_FILTER_DISABLE =				1;
		static int	SHTPS_SMOOTH_FILTER_VALID_COUNT =			5;
		...
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_SMOOTH_FILTER_DISABLE						1
		#define SHTPS_SMOOTH_FILTER_VALID_COUNT					5
